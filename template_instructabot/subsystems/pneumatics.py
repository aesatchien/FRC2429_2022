...
class Pneumatics(SubsystemBase):
    def __init__(self):
        ...
        self.intake_piston = Solenoid(wpilib.PneumaticsModuleType.CTREPCM, 3)
        self.shifter = Solenoid(wpilib.PneumaticsModuleType.CTREPCM, 2)
        self.climber_piston_long = Solenoid(wpilib.PneumaticsModuleType.CTREPCM, 6)
        self.climber_piston_short = Solenoid(wpilib.PneumaticsModuleType.CTREPCM, 7)

        self.shooter_hood_piston = DoubleSolenoid(wpilib.PneumaticsModuleType.CTREPCM, 4, 5)
