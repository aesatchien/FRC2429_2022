...
class Drivetrain(SubsystemBase):
    def __init__(self):
        ...
        self.left_motors = MotorControllerGroup(self.spark_neo_left_front, self.spark_neo_left_rear)
        self.right_motors = MotorControllerGroup(self.spark_neo_right_front, self.spark_neo_right_rear)
        ...
        self.odometry = DifferentialDriveOdometry(gyroAngle=geo.Rotation2d.fromDegrees(-self.navx.getAngle()), initialPose=geo.Pose2d(constants.k_start_x, constants.k_start_y,
                                                                         geo.Rotation2d.fromDegrees(constants.k_start_heading)), leftDistance=0, rightDistance=0)
        # self.odometry = DifferentialDriveOdometry(gyroAngle=)
        # self.odometry = None
