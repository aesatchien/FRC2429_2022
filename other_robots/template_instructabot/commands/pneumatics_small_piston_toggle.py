...
class SmallPistonToggle(commands2.CommandBase):
    ...
    def initialize(self) -> None:
        ...
        if self.force == 'extend':
            self.pneumatics.set_small_piston_position(position='extend')
        elif self.force == 'retract':
            self.pneumatics.set_small_piston_position(position='retract')
        else:
            self.pneumatics.toggle_small_piston_position()
